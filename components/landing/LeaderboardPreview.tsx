      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-gray-600">
            Siapa saja yang memilah production terbanyak bulan ini?
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          {/* Header */}
          <div className="bg-linear-to-r from-amber-500 to-rose-600 px-6 md:px-8 py-6">
            <h3 className="text-xl font-bold text-white">Leaderboard Global</h3>
            <p className="text-amber-100 text-sm mt-1">Ranking pemilah production terbaik bulan ini</p>
          </div>
          ...
          <div className="divide-y divide-gray-200">
            {leaderboardUsers.map((user, index) => (
              <motion.div
                ...
                className="px-6 md:px-8 py-4 hover:bg-amber-50/50 transition-colors duration-200"
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex items-center gap-3 flex-1">
                      <div className="w-10 h-10 rounded-full bg-linear-to-br from-amber-200 to-rose-200 flex items-center justify-center text-xl">
                        {user.avatar}
                      </div>
                      <div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="text-lg font-bold text-amber-600">{user.points}</span>
                ...
                <div className="mt-3 ml-16 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-linear-to-r from-amber-400 to-rose-500 rounded-full"
          ...
          <div className="bg-gray-50 px-6 md:px-8 py-4 flex items-center justify-between">
            ...
            <button className="text-amber-600 hover:text-amber-700 font-semibold text-sm transition-colors">
              Lihat Semua →
            </button>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-amber-50 border border-amber-200 rounded-full">
            ...
            <p className="text-sm font-semibold text-amber-700">Setiap pemilahan yang tepat naik 5 peringkat di leaderboard!</p>
          </div>
        </div>
      </div>
    </section>
